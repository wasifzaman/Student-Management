...
w.add_widget_to(DefaultButton, 1, exec_func=w.generate_data_table, bg='#2B58A6', fg='white', attributes={'text': 'Log In'}, image=images + 'Login-Door-128.png')
w.add_widget_to(DefaultButton, 1, exec_func=w.generate_data_table, bg='#2B58A6', fg='white', attributes={'text': 'Log Out'}, image=images + 'Logout-Door-128.png')
