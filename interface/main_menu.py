...
main_window.add_widget_to(DefaultButton, 1, exec_func=main_window.generate_data_table, bg='#2B58A6', fg='white', attributes={'text': 'Settings'}, image=images + 'Settings-01-128.png')
